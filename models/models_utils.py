...
def average_pool_infloat_e5(last_hidden_states: Tensor,
...
URL_MODELS = {
    "ibot-large": "https://lf3-nlp-opensource.bytetos.com/obj/nlp-opensource/archive/2022/ibot/vitl_16/checkpoint_teacher.pth",
    "ibot-base": "https://lf3-nlp-opensource.bytetos.com/obj/nlp-opensource/archive/2022/ibot/vitb_16/checkpoint_teacher.pth",
    "ijepa-huge": "https://dl.fbaipublicfiles.com/ijepa/IN1K-vit.h.14-300e.pth.tar",
...
class CustomImageProcessor(ImageProcessingMixin):
    ...
    def __call__(self, images, return_tensors=None):
        ...
        if return_tensors == 'pt':
            ...
            return processed_images
def load_pretrained_weights_ijepa(model, model_name=None):
    current_dir = "./"
    pretrained_weights = f"./backbone_checkpoints/{model_name}.pth"
    ...
    ckpt = torch.load(pretrained_weights, map_location=torch.device('cpu'))
    pretrained_dict = ckpt['encoder']
    for k, v in pretrained_dict.items():
        model.state_dict()[k[len("module."):]].copy_(v)
    return

def load_pretrained_weights_ibot(model, checkpoint_key='teacher', model_name=None, patch_size=16):
    current_dir = "./"
    pretrained_weights = f"./backbone_checkpoints/{model_name}.pth"
